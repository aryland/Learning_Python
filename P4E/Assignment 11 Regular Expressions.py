...
9161 to the hardware and we end up with a Personal Digital 9789
...
6928 Interestingly, the kinds of things computers can do best 7123
...
8722 the opposite is true, reading and understanding text 2846
...
5139 skilled at talking computer language.  Once you learn
6300 this new language, you can delegate mundane tasks
...
For 378 now, 5634 our 2489 primary motivation is not to make money or please end users, but
...
toward 996 developing 1179 programs 8599 for others.
 
8240 Computer hardware architecture 4701
...
3755 with what is next?  If your computer is rated
...
2390 to computer builders, it helps to have some terminology 5237
...
2 be correct programming. 897

5960 Understanding programming 9561
...
In 8712 a 9783 sense, 9919 you need two skills to be a programmer:
...
9464 feedback.  In programming, our program is the story and the 
...
8372 write a program that solves that problem.  And once you get 298
...
sit, 3758 stay, 6517 and 8258 fetch.  When you talk to a dog and
...
class     exec      in        raise              
continue 9304  4936 finally 5148   is        return             
 def       for       lambda    try
...
but 4885 for 7397 now 1329 we will focus on the Python equivalent of speak (in 
...
by 8782 a 731 string 7768 of text of our choosing enclosed in single quotes.
...
6909 instructions and screencasts of setting up and starting Python 
on Macintosh and Windows systems.  At some point, you will be in 
a terminal or command window and you will type python and 
2443 the Python interpreter will start executing in interactive mode
...
1480 programmers using Python to talk to the users of your program. 1468
...
language 8237 is 1288 very 2782 simple and frankly very tiresome to write because it 
...
7522 and is ready for us to type another line of Python. 2821
...
term 2426 variable 9813 to 2060 refer to the labels we use to refer to this stored data.
...
3089 to retrieve data created in earlier statements.   We are writing our first 
...
it 5445 written 6842 in? 1021  Is it written in a compiled language?  When we type
 python, what exactly is happening?

The 7336 Python 2570 interpreter 3709 is written in a high-level language called C.  
 5807 You can look at the actual source code for the Python interpreter by 6514
...
6882 the file hello.py instead of prompting us for lines of Python code 6249
interactively.
